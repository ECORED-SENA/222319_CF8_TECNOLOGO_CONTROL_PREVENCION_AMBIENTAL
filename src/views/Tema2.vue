  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-7(data-aos="fade-left")
        .jumbotron.p-5 
          p.mb-0 Las preocupaciones que han surgido en diversas décadas por los cambios climáticos han agrupado a diferentes economías que se interesan especialmente por los evidentes cambios que se presentan en la naturaleza y que directamente afectan a diversas naciones, impactando su economía y consecuentemente la sociedad. Por esta razón, es importante reconocer cuál ha sido la cronología en las diversas negociaciones que se han realizado a nivel mundial sobre el clima y qué países se han involucrado en estos acuerdos.

      .col-lg-4(data-aos="fade-right") 
        img.img-a(src='@/assets/curso/images/tema2/img_1.png'  alt='').my-3
    
    p.mb-5 En la siguiente línea de tiempo, se presenta un listado y descripción de diversos acuerdos y tratados que se han venido gestando a través del tiempo. Se recomienda tomar nota atenta de ellos. ¡Adelante!

    .tarjeta.tarjeta--gris.p-4.mb-5(data-aos="zoom-in-down")
      LineaTiempoC.color-acento-contenido(text-small)
        .row.justify-content-center.align-items-center(titulo="1972")
        ...
        .row.justify-content-center.align-items-center(titulo="1979")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/images/tema2/ico_2.svg",  alt='', style="width:160px; display:block; margin:auto 0 ;")
          .col-md-6.lg-6
            p Tiene lugar la primera Conferencia Mundial sobre el Clima.
                  
        .row.justify-content-center.align-items-center(titulo="1988")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/images/tema2/ico_3.svg",  alt='', style="width:160px; display:block; margin:auto 0 ;")
          .col-md-6.lg-6
            p Se crea el grupo intergubernamental de expertos sobre el cambio climático (IPCC). Más información sobre la ciencia del cambio climático.
        .row.justify-content-center.align-items-center(titulo="1990")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/images/tema2/ico_4.svg",  alt='', style="width:160px; display:block; margin:auto 0 ;")
          .col-md-6.lg-6
            p El IPCC y la segunda Conferencia Mundial sobre el Clima piden un tratado mundial sobre el cambio climático. Comienzan las negociaciones de la asamblea general de las Naciones Unidas sobre una convención marco.

        .row.justify-content-center.align-items-center(titulo="1991")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/images/tema2/ico_5.svg",  alt='', style="width:160px; display:block; margin:auto 0 ;")
          .col-md-6.lg-6
            p Tiene lugar la primera reunión del comité intergubernamental de negociación.
                  
        .row.justify-content-center.align-items-center(titulo="1992")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
        ...
        .row.justify-content-center.align-items-center(titulo="1994")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/images/tema2/ico_7.svg",  alt='', style="width:160px; display:block; margin:auto 0 ;")
           
          .col-md-6.lg-6
            p Entra en vigor la CMNUCC.


        .row.justify-content-center.align-items-center(titulo="1995")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/images/tema2/ico_8.svg",  alt='', style="width:160px; display:block; margin:auto 0 ;")

          .col-md-6.lg-6
            p Se celebra la primera conferencia de las partes (CP1) en Berlín.

                  
        .row.justify-content-center.align-items-center(titulo="1996")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/images/tema2/ico_9.svg",  alt='', style="width:160px; display:block; margin:auto 0 ;")

          .col-md-6.lg-6
            p Se crea la secretaría de la CMNUCC para respaldar las medidas adoptadas en el marco de la convención.
        ...
        .row.justify-content-center.align-items-center(titulo="2014")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/images/tema2/ico_19.svg",  alt='', style="width:160px; display:block; margin:auto 0 ;")
          .col-md-6.lg-6
            p La CP20 se celebra en diciembre en Lima (Perú).
                  
        .row.justify-content-center.align-items-center(titulo="2015")
          .col-6.col-lg-4.mb-4.mb-lg-0
            figure
              img(src="@/assets/curso/images/tema2/ico_20.svg",  alt='', style="width:160px; display:block; margin:auto 0 ;")
          .col-md-6.lg-6
            p La CP21 o RP11 se celebra en diciembre en París (Francia).

    p.mb-3 Hasta este punto, ha podido conocer algunos acuerdos internacionales para favorecer el medio ambiente y que intentan combatir el cambio climático y sus efectos negativos. Está invitado ahora a enterarse de un acuerdo en particular, firmado por Colombia. Preste atención al mismo y sus particularidades.
